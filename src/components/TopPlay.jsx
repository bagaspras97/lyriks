...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className="w-full flex flex-row items-center hover:bg-[#4c426e] py-2 p-4 rounded-lg cursor-pointer mb-2">
    ...
    <div className="flex-1 flex flex-row justify-between items-center">
      <img className="w-20 h-220 rounded-lg" src={song?.images?.coverart} alt={song?.title} />
...
const TopPlay = () => {
  ...
  const state = useGetTopChartsQuery();
    ...
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col">
      <div className="w-full flex flex-col">
        <div className="flex flex-row justify-between items-center">
          ...
          <Link className="text-gray-300 text-base cursor-pointer" to="/top-charts">
            <p>See more</p>
          </Link>
        </div>
      ...
      <div className="w-full flex flex-col mt-8">
        <div className="flex flex-row justify-between items-center">
          ...
          <Link className="text-gray-300 text-base cursor-pointer" to="/top-artists">
            <p>See more</p>
          </Link>
        </div>
